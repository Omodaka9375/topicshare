...
## Poison Data
I avoid malicous user input in TopicShare Bounty by:
...
## Exposed Secrets
TopicShare Bounty does not store any secret information on the blockchain.

## Miner Vulnerabilities
TopicShare Bounty does not rely on any timestamp or block information.

## `tx.origin` Problem
TopicShare Bounty does not use `tx.origin` anywhere

## Gas Limit
I avoid gas limit issues by:
* Not using any loops in TopicShare Bounty
